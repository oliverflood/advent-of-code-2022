...
int main() {
	...
	for (int i = 0; i < input.size(); ++i)
	{
		...
		if (input[i][1] == "cd" && input[i][2] != "..") {
			...
			if (stack3[stack3.size()-1] <= 100000) {
				directory_sum += stack3[stack3.size()-1];
			}
	...
	cout << "directory_sum: " << directory_sum << endl;
	cout << "space needed: " << (70000000-stack3[0]);
